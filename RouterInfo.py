...
appPayload = "wanlink()"  # Your payload
appPayload = "memory_usage()"  # Your payload
appPayload = "get_clientlist()"  # Your payload
appPayload = "apps_info()"  # Your payload
appPayload = "uptime()"  # Your payload
appPayload = "qrate()"  # Your payload
appPayload = "get_machine_name()"  # Your payload
appPayload = "wanlink(ipaddr)"  # Your payload

appPayload = "netdev(appobj)"  # Your payload
...
class RouterInfo:
    ...
    def __authenticate(self, ipaddress, username, password):
        ...
        logintoken = base64.b64encode(string.encode('ascii')).decode('ascii')
    ...
    def get_clientlist(self):
        ...
        Format: {"get_clientlist":{"AC:84:C6:6C:A7:C0":{"type": "2", "defaultType": "0", "name": "Archer_C1200",
                                  ...
                                  "maclist": ["AC:84:C6:6C:A7:C0"], "ClientAPILevel": "2" }}
        '''
